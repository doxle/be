...
# Create or update the Step Functions state machine used by async block backups.
#
# Required:
#   WORKER_FUNCTION_ARN  - Lambda ARN used by Step Functions (function or alias ARN)
#
# Optional:
#   STATE_MACHINE_NAME   - defaults to doxle-block-backup
...
ASL_TEMPLATE="${BE_ROOT}/stepfunctions/block_backup_state_machine.asl.json"
...
echo "BACKUP_STATE_MACHINE_ARN=${STATE_MACHINE_ARN}"
